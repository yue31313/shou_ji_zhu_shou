...
public class MainActivityqq extends Activity implements OnCheckedChangeListener,
		OnTouchListener, android.widget.RadioGroup.OnCheckedChangeListener {
	...
	public void init() {
		...
		timeshow1 = (TextView) findViewById(R.id.timeshow1);
		...
		mHandler = new Handler() {
			public void handleMessage(Message msg) {
				...
				case NaolingActivity.GUINOTIFIER:
					...
					timeshow.setText(format(hour) + " : " + format(minute)+" : "+format(miao));
					timeshow1.setText(year+"年"+month+"月"+day+"日");
					break;
		...
		public void run() {
			...
			try {
...

				{
					...
					m.what = MainActivityqq.GUINOTIFIER;

					MainActivityqq.this.mHandler.sendMessage(m);

				} while (MainActivityqq.LooperThread.interrupted() == false);
